    ...
    faq: [
      {
        ...
        answer: "汽車借款通常需要行照正本，因為行照能確認車輛與車主資料。若目前行照不在身邊，可以先來電說明狀況，但正式評估與簽約仍需依現場要求準備完整文件。",
      },
      {
      ...
      },
      {
        ...
        answer: "車子仍有分期可以先諮詢，但是否能辦理與可討論金額，會依剩餘貸款、車輛價值、文件與契約評估。建議先準備行照、雙證件，並告知目前貸款概況。",
      },
      {
        question: "汽車借款可以當天撥款嗎？",
        answer: "資料齊全、車主與車輛到場且評估完成時，才有機會較快處理。實際撥款時間仍需依文件、車況、契約確認與現場作業為準，不建議只依廣告承諾判斷。",
      },
      {
        question: "汽車借款會查聯徵嗎？",
